...
Kedua cara juga otomatis menonaktifkan (`active: false`) produk lama yang
sudah tidak ada di seed file, jadi paket yang dihapus tidak lagi muncul
di form pemesanan tanpa perlu hapus manual di Firestore Console.
