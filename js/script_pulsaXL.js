...
const buyDiamond = [
    {name: "Top Up Pulsa XL", price: "Rp 7.000", diamond: "5.000 Pulsa XL"},
    {name: "Top Up Pulsa XL", price: "Rp 12.000", diamond: "10.000 Pulsa XL"},
    {name: "Top Up Pulsa XL", price: "Rp 22.000", diamond: "20.000 Pulsa XL"},
    {name: "Top Up Pulsa XL", price: "Rp 38.000", diamond: "35.000 Pulsa XL"},
    {name: "Top Up Pulsa XL", price: "Rp 53.000", diamond: "50.000 Pulsa XL"},
    {name: "Top Up Pulsa XL", price: "Rp 78.000", diamond: "75.000 Pulsa XL"},
    {name: "Top Up Pulsa XL", price: "Rp 105.000", diamond: "100.000 Pulsa XL"},
    {name: "Top Up Pulsa XL", price: "Rp 155.000", diamond: "150.000 Pulsa XL"},
    {name: "Top Up Pulsa XL", price: "Rp 205.000", diamond: "200.000 Pulsa XL"},
]
...
if (konfirmasiBtn && !konfirmasiBtn.dataset.listenerAttached) {
    const handleKonfirmasi = () => {
        ...
        const url =
            ...
            "Saya ingin top up Pulsa XL dengan nominal *" + encodeURIComponent(produk) +
