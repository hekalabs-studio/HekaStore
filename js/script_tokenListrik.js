...
const buyDiamond = [
    {name: "Top Up Pulsa Listrik", price: "Rp 23.000", diamond: "20.000 Pulsa Listrik"},
    {name: "Top Up Pulsa Listrik", price: "Rp 53.000", diamond: "50.000 Pulsa Listrik"},
    {name: "Top Up Pulsa Listrik", price: "Rp 105.000", diamond: "100.000 Pulsa Listrik"},
    {name: "Top Up Pulsa Listrik", price: "Rp 155.000", diamond: "150.000 Pulsa Listrik"},
    {name: "Top Up Pulsa Listrik", price: "Rp 205.000", diamond: "200.000 Pulsa Listrik"},
]
...
if (konfirmasiBtn && !konfirmasiBtn.dataset.listenerAttached) {
    const handleKonfirmasi = () => {
        ...
        const url =
            ...
            "Saya ingin top up Pulsa Listrik dengan nominal *" + encodeURIComponent(produk) +
