...
(function () {
  ...
  const CATALOG = [
    ...
    { name: "Jasa Digital", img: P + "img/logotoko2.webp", link: IN_HTML_DIR ? "jasaDigital.html" : "html/jasaDigital.html", category: "Jasa Digital", keywords: "jasa website web app landing page edit video motion graphic iot smart home hekalabs developer" },
  ];
