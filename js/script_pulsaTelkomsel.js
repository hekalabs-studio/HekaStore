...
const buyDiamond = [
    {name: "Top Up Pulsa Telkomsel", price: "Rp 7.000", diamond: "5.000 Pulsa Telkomsel"},
    {name: "Top Up Pulsa Telkomsel", price: "Rp 12.000", diamond: "10.000 Pulsa Telkomsel"},
    {name: "Top Up Pulsa Telkomsel", price: "Rp 22.000", diamond: "20.000 Pulsa Telkomsel"},
    {name: "Top Up Pulsa Telkomsel", price: "Rp 38.000", diamond: "35.000 Pulsa Telkomsel"},
    {name: "Top Up Pulsa Telkomsel", price: "Rp 53.000", diamond: "50.000 Pulsa Telkomsel"},
    {name: "Top Up Pulsa Telkomsel", price: "Rp 78.000", diamond: "75.000 Pulsa Telkomsel"},
    {name: "Top Up Pulsa Telkomsel", price: "Rp 105.000", diamond: "100.000 Pulsa Telkomsel"},
    {name: "Top Up Pulsa Telkomsel", price: "Rp 155.000", diamond: "150.000 Pulsa Telkomsel"},
    {name: "Top Up Pulsa Telkomsel", price: "Rp 205.000", diamond: "200.000 Pulsa Telkomsel"},
]
...
if (konfirmasiBtn && !konfirmasiBtn.dataset.listenerAttached) {
    const handleKonfirmasi = () => {
        ...
        const url =
            ...
            "Saya ingin top up Pulsa Telkomsel dengan nominal *" + encodeURIComponent(produk) +
